                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        if (strcasecmp($row["word"], $usrWord) == 0) {
                            ...
                            echo "<h3>Congratulations</h3> <h2 style='font-family: serif;' >The Correct Word was: " . $row["word"] . "</h2>";
                ?>
                            <script>
                            ...
                            echo "<h3> Incrorrect </h3> <h2 style='font-family: serif;'>The Correct Word was: " . $row["word"] . "</h2>";

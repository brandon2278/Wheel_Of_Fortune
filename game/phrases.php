...
<body id="home">
    ...
    <script>
        ...
        var key = document.getElementsByClassName("keyboard-letters")[0];
        ...
        var key1 = document.getElementsByClassName("keyboard-letters")[1];
        key1.onclick = function() {
            key1 = key1.innerHTML;
            for (var i = 0; i < length; i++) {
                var id = i.toString();
                var letter = document.getElementById(id);
                if (word[i].equalsIgnoreCase(key1)) {
                    reveal();
                    if (localStorage.getItem('savedLetter') != null && !(localStorage.getItem('savedLetter').includes(key1))) {
                        savedLetter = savedLetter.concat(key1);
                    } else if (localStorage.getItem('savedLetter') == null) {
                        savedLetter = key1;
                    }
                    localStorage.setItem('savedLetter', savedLetter);
        ...
        var key2 = document.getElementsByClassName("keyboard-letters")[2];
        key2.onclick = function() {
            key2 = key2.innerHTML;
            for (var i = 0; i < length; i++) {
                var id = i.toString();
                var letter = document.getElementById(id);
                if (word[i].equalsIgnoreCase(key2)) {
                    reveal();
                    if (localStorage.getItem('savedLetter') != null && !(localStorage.getItem('savedLetter').includes(key2))) {
                        savedLetter = savedLetter.concat(key2);
                    } else if (localStorage.getItem('savedLetter') == null) {
                        savedLetter = key2;
                    }
        ...
        var key3 = document.getElementsByClassName("keyboard-letters")[3];
        key3.onclick = function() {
            key3 = key3.innerHTML;
            for (var i = 0; i < length; i++) {
                var id = i.toString();
                var letter = document.getElementById(id);
                if (word[i].equalsIgnoreCase(key3)) {
                    reveal();
                    if (localStorage.getItem('savedLetter') != null && !(localStorage.getItem('savedLetter').includes(key3))) {
                        savedLetter = savedLetter.concat(key3);
                    } else if (localStorage.getItem('savedLetter') == null) {
                        savedLetter = key3;
                    }
                    localStorage.setItem('savedLetter', savedLetter);
        ...
        var key4 = document.getElementsByClassName("keyboard-letters")[4];
        key4.onclick = function() {
            key4 = key4.innerHTML;
            for (var i = 0; i < length; i++) {
                var id = i.toString();
                var letter = document.getElementById(id);
                if (word[i].equalsIgnoreCase(key4)) {
                    reveal();
                    if (localStorage.getItem('savedLetter') != null && !(localStorage.getItem('savedLetter').includes(key4))) {
                        savedLetter = savedLetter.concat(key4);
                    } else if (localStorage.getItem('savedLetter') == null) {
                        savedLetter = key4;
                    }
                    localStorage.setItem('savedLetter', savedLetter);
        ...
        var key5 = document.getElementsByClassName("keyboard-letters")[5];
        key5.onclick = function() {
            key5 = key5.innerHTML;
            for (var i = 0; i < length; i++) {
                var id = i.toString();
                var letter = document.getElementById(id);
                if (word[i].equalsIgnoreCase(key5)) {
                    reveal();
                    if (localStorage.getItem('savedLetter') != null && !(localStorage.getItem('savedLetter').includes(key5))) {
                        savedLetter = savedLetter.concat(key5);
                    } else if (localStorage.getItem('savedLetter') == null) {
                        savedLetter = key5;
                    }
                    localStorage.setItem('savedLetter', savedLetter);
        ...
        var key6 = document.getElementsByClassName("keyboard-letters")[6];
        key6.onclick = function() {
            key6 = key6.innerHTML;
            for (var i = 0; i < length; i++) {
                var id = i.toString();
                var letter = document.getElementById(id);
                if (word[i].equalsIgnoreCase(key6)) {
                    reveal();
                    if (localStorage.getItem('savedLetter') != null && !(localStorage.getItem('savedLetter').includes(key4))) {
                        savedLetter = savedLetter.concat(key6);
                    } else if (localStorage.getItem('savedLetter') == null) {
                        savedLetter = key6;
                    }
                    localStorage.setItem('savedLetter', savedLetter);
        ...
        var key7 = document.getElementsByClassName("keyboard-letters")[7];
        key7.onclick = function() {
            key7 = key7.innerHTML;
            for (var i = 0; i < length; i++) {
                var id = i.toString();
                var letter = document.getElementById(id);
                if (word[i].equalsIgnoreCase(key7)) {
                    reveal();
                    if (localStorage.getItem('savedLetter') != null && !(localStorage.getItem('savedLetter').includes(key7))) {
                        savedLetter = savedLetter.concat(key7);
                    } else if (localStorage.getItem('savedLetter') == null) {
                        savedLetter = key7;
                    }
                    localStorage.setItem('savedLetter', savedLetter);
        ...
        var key8 = document.getElementsByClassName("keyboard-letters")[8];
        key8.onclick = function() {
            key8 = key8.innerHTML;
            for (var i = 0; i < length; i++) {
                var id = i.toString();
                var letter = document.getElementById(id);
                if (word[i].equalsIgnoreCase(key8)) {
                    reveal();
                    if (localStorage.getItem('savedLetter') != null && !(localStorage.getItem('savedLetter').includes(key8))) {
                        savedLetter = savedLetter.concat(key8);
                    } else if (localStorage.getItem('savedLetter') == null) {
                        savedLetter = key8;
                    }
                    localStorage.setItem('savedLetter', savedLetter);
        ...
        var key9 = document.getElementsByClassName("keyboard-letters")[9];
        key9.onclick = function() {
            key9 = key9.innerHTML;
            for (var i = 0; i < length; i++) {
                var id = i.toString();
                var letter = document.getElementById(id);
                if (word[i].equalsIgnoreCase(key9)) {
                    reveal();
                    if (localStorage.getItem('savedLetter') != null && !(localStorage.getItem('savedLetter').includes(key9))) {
                        savedLetter = savedLetter.concat(key9);
                    } else if (localStorage.getItem('savedLetter') == null) {
                        savedLetter = key9;
                    }
                    localStorage.setItem('savedLetter', savedLetter);
        ...
        var key10 = document.getElementsByClassName("keyboard-letters")[10];
        key10.onclick = function() {
            key10 = key10.innerHTML;
            for (var i = 0; i < length; i++) {
                var id = i.toString();
                var letter = document.getElementById(id);
                if (word[i].equalsIgnoreCase(key10)) {
                    reveal();
                    if (localStorage.getItem('savedLetter') != null && !(localStorage.getItem('savedLetter').includes(key10))) {
                        savedLetter = savedLetter.concat(key10);
                    } else if (localStorage.getItem('savedLetter') == null) {
                        savedLetter = key10;
                    }
                    localStorage.setItem('savedLetter', savedLetter);
        ...
        var key11 = document.getElementsByClassName("keyboard-letters")[11];
        key11.onclick = function() {
            key11 = key11.innerHTML;
            for (var i = 0; i < length; i++) {
                var id = i.toString();
                var letter = document.getElementById(id);
                if (word[i].equalsIgnoreCase(key11)) {
                    reveal();
                    if (localStorage.getItem('savedLetter') != null && !(localStorage.getItem('savedLetter').includes(key11))) {
                        savedLetter = savedLetter.concat(key11);
                    } else if (localStorage.getItem('savedLetter') == null) {
                        savedLetter = key11;
                    }
                    localStorage.setItem('savedLetter', savedLetter);
        ...
        var key12 = document.getElementsByClassName("keyboard-letters")[12];
        key12.onclick = function() {
            key12 = key12.innerHTML;
            for (var i = 0; i < length; i++) {
                var id = i.toString();
                var letter = document.getElementById(id);
                if (word[i].equalsIgnoreCase(key12)) {
                    reveal();
                    if (localStorage.getItem('savedLetter') != null && !(localStorage.getItem('savedLetter').includes(key12))) {
                        savedLetter = savedLetter.concat(key12);
                    } else if (localStorage.getItem('savedLetter') == null) {
                        savedLetter = key12;
                    }
                    localStorage.setItem('savedLetter', savedLetter);
        ...
        var key13 = document.getElementsByClassName("keyboard-letters")[13];
        key13.onclick = function() {
            key13 = key13.innerHTML;
            for (var i = 0; i < length; i++) {
                var id = i.toString();
                var letter = document.getElementById(id);
                if (word[i].equalsIgnoreCase(key13)) {
                    reveal();
                    if (localStorage.getItem('savedLetter') != null && !(localStorage.getItem('savedLetter').includes(key13))) {
                        savedLetter = savedLetter.concat(key13);
                    } else if (localStorage.getItem('savedLetter') == null) {
                        savedLetter = key13;
                    }
                    localStorage.setItem('savedLetter', savedLetter);
        ...
        var key14 = document.getElementsByClassName("keyboard-letters")[14];
        key14.onclick = function() {
            key14 = key14.innerHTML;
            for (var i = 0; i < length; i++) {
                var id = i.toString();
                var letter = document.getElementById(id);
                if (word[i].equalsIgnoreCase(key14)) {
                    reveal();
                    if (localStorage.getItem('savedLetter') != null && !(localStorage.getItem('savedLetter').includes(key14))) {
                        savedLetter = savedLetter.concat(key14);
                    } else if (localStorage.getItem('savedLetter') == null) {
                        savedLetter = key14;
                    }
                    localStorage.setItem('savedLetter', savedLetter);
        ...
        var key15 = document.getElementsByClassName("keyboard-letters")[15];
        key15.onclick = function() {
            key15 = key15.innerHTML;
            for (var i = 0; i < length; i++) {
                var id = i.toString();
                var letter = document.getElementById(id);
                if (word[i].equalsIgnoreCase(key15)) {
                    reveal();
                    if (localStorage.getItem('savedLetter') != null && !(localStorage.getItem('savedLetter').includes(key15))) {
                        savedLetter = savedLetter.concat(key15);
                    } else if (localStorage.getItem('savedLetter') == null) {
                        savedLetter = key15;
                    }
                    localStorage.setItem('savedLetter', savedLetter);
        ...
        var key16 = document.getElementsByClassName("keyboard-letters")[16];
        key16.onclick = function() {
            key16 = key16.innerHTML;
            for (var i = 0; i < length; i++) {
                var id = i.toString();
                var letter = document.getElementById(id);
                if (word[i].equalsIgnoreCase(key16)) {
                    reveal();
                    if (localStorage.getItem('savedLetter') != null && !(localStorage.getItem('savedLetter').includes(key16))) {
                        savedLetter = savedLetter.concat(key16);
                    } else if (localStorage.getItem('savedLetter') == null) {
                        savedLetter = key16;
                    }
                    localStorage.setItem('savedLetter', savedLetter);
        ...
        var key17 = document.getElementsByClassName("keyboard-letters")[17];
        key17.onclick = function() {
            key17 = key17.innerHTML;
            for (var i = 0; i < length; i++) {
                var id = i.toString();
                var letter = document.getElementById(id);
                if (word[i].equalsIgnoreCase(key17)) {
                    reveal();
                    if (localStorage.getItem('savedLetter') != null && !(localStorage.getItem('savedLetter').includes(key17))) {
                        savedLetter = savedLetter.concat(key17);
                    } else if (localStorage.getItem('savedLetter') == null) {
                        savedLetter = key17;
                    }
                    localStorage.setItem('savedLetter', savedLetter);
        ...
        var key18 = document.getElementsByClassName("keyboard-letters")[18];
        key18.onclick = function() {
            key18 = key18.innerHTML;
            for (var i = 0; i < length; i++) {
                var id = i.toString();
                var letter = document.getElementById(id);
                if (word[i].equalsIgnoreCase(key18)) {
                    reveal();
                    if (localStorage.getItem('savedLetter') != null && !(localStorage.getItem('savedLetter').includes(key18))) {
                        savedLetter = savedLetter.concat(key18);
                    } else if (localStorage.getItem('savedLetter') == null) {
                        savedLetter = key18;
                    }
                    localStorage.setItem('savedLetter', savedLetter);
        ...
        var key19 = document.getElementsByClassName("keyboard-letters")[19];
        key19.onclick = function() {
            key19 = key19.innerHTML;
            for (var i = 0; i < length; i++) {
                var id = i.toString();
                var letter = document.getElementById(id);
                if (word[i].equalsIgnoreCase(key19)) {
                    reveal();
                    if (localStorage.getItem('savedLetter') != null && !(localStorage.getItem('savedLetter').includes(key19))) {
                        savedLetter = savedLetter.concat(key19);
                    } else if (localStorage.getItem('savedLetter') == null) {
                        savedLetter = key19;
                    }
                    localStorage.setItem('savedLetter', savedLetter);
        ...
        var key20 = document.getElementsByClassName("keyboard-letters")[20];
        key20.onclick = function() {
            key20 = key20.innerHTML;
            for (var i = 0; i < length; i++) {
                var id = i.toString();
                var letter = document.getElementById(id);
                if (word[i].equalsIgnoreCase(key20)) {
                    reveal();
                    if (localStorage.getItem('savedLetter') != null && !(localStorage.getItem('savedLetter').includes(key20))) {
                        savedLetter = savedLetter.concat(key20);
                    } else if (localStorage.getItem('savedLetter') == null) {
                        savedLetter = key20;
                    }
                    localStorage.setItem('savedLetter', savedLetter);
        ...
        var key21 = document.getElementsByClassName("keyboard-letters")[21];
        key21.onclick = function() {
            key21 = key21.innerHTML;
            for (var i = 0; i < length; i++) {
                var id = i.toString();
                var letter = document.getElementById(id);
                if (word[i].equalsIgnoreCase(key21)) {
                    reveal();
                    if (localStorage.getItem('savedLetter') != null && !(localStorage.getItem('savedLetter').includes(key21))) {
                        savedLetter = savedLetter.concat(key21);
                    } else if (localStorage.getItem('savedLetter') == null) {
                        savedLetter = key21;
                    }
                    localStorage.setItem('savedLetter', savedLetter);

...
<body id="home">
        ...
        <div>
            <div>
                ...
                <div id='solve' class="modal">
                    <div class='translater'>
                        <div id="solved">
  				<span id=\"closed1\" class=\"close\">&times;</span><div><form class="container" action="" method="post" >
    				<div class="form-outline mb-4">
    				<label class="form-label" for=\"guess\">Enter Guess:</label>
    				<input class="form-control form-control-lg useLobbyKeyboard" name="guess" type="text"></div>
    ...
    <center><button id="solvePhrase" class="btn btn-warning" style="margin-top: -20px; margin-bottom: 20px;">SOLVE</button></center>

        ...
        <div>
            ...
            <ul>
                ...
                if (isset($_POST['delete'])) {
                    ...
                    $set = 'SET @num = 0';
                    $reset = 'UPDATE phrases SET id = @num := (@num+1)';
                    $auto = 'ALTER TABLE phrases AUTO_INCREMENT = 1';
                ...
                $sql = "SELECT id, phrase, response, translation, respTranslation, phraseSound, responseSound FROM $table";

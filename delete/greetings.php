        ...
        <div>
            ...
            <ul>
                ...
                if (isset($_POST['delete'])) {
                    ...
                    $set = 'SET @num = 0';
                    $reset = 'UPDATE greetings SET id = @num := (@num+1)';
                    $auto = 'ALTER TABLE greetings AUTO_INCREMENT = 1';
                ...
                $sql = "SELECT id, word, englishWord, sound FROM $table";
                $result = $conn->query($sql);

                if ($result->num_rows > 0) {
                    // output data of each row
                    while ($row = $result->fetch_assoc()) {
                        echo "<li>Word Id: " . $row["id"] . " - Mi'kmaw Word: " . $row["word"] . " - English Word: " . $row["englishWord"] . " - SoundFile: " . $row["sound"] . "</li>";
                    }
                } else {
                    echo "0 results";
                }

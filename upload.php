...
<body id="home" class="index">
    ...
    <center>
        <div align="center" class="home-screen">
            <h2>Choose a Category</h2>
            <ul class="list-unstyled">
                <form action="upload/picUpload.php" method="get">
                ...
                <form action="upload/wordUpload.php" method="get">
                ...
                <form action="upload/phrases.php" method="get">

        ...
        <div class="home-screen">
            <div align="center">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><a class="btn btn-dark" href="upload/food.php" role="button"> Food </a></li>
                    <li><a class="btn btn-dark" href="upload/earth.php" role="button"> Earth </a></li>
                    <li><a class="btn btn-dark" href="upload/numbers.php" role="button"> Numbers </a></li>
                </ul>

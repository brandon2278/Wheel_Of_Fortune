...
<body id="home" class="index">
    ...
    <section class="container">
        ...
        if (isset($_SESSION['userId'])) {
            ...
            <li><a class="btn btn-dark" href="SelectCategory.php" role="button"> Single Player </a>
                <p>Play and Learn on your own at your own pace!</p>
            </li>
            <li><a class="btn btn-dark" href="SelectLobby.php" role="button"> Multiplayer </a>
                <p>Play with your friends, chat online and learn together in a fun way!</p>
            </li>
            <li><a class="btn btn-dark" href="Leaderboard.php" role="button"> Leaderboard </a>

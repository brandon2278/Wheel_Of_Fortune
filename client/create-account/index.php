						...
						<div class="col-12 col-md-9 col-lg-7 col-xl-6">
							<div class="card bg-dark" style="border-radius: 15px; color:  rgb(255, 223, 79); --bs-bg-opacity: 0.8;">
								<div class="card-body p-5">
									...
									<form action="../src/php/signup.inc.php" method="post" style="margin: 0 70px 0 70px;">
										...
										<p class="text-center text-muted mt-5 mb-0">Already have an account? <a href="../" class="text-white-50 fw-bold"><u>Login here</u></a></p>

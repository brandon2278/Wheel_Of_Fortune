	...
	<center>
		<div>
			<div>
				...
				$sql = "SELECT id, word, englishWord, sound FROM $table WHERE id=$num";
				...
				if ($result->num_rows > 0) {
					...
					while ($row = $result->fetch_assoc()) {
						...
						echo "<h3> English Word: <h3 style='font-family: serif;'>" . $row["englishWord"] . "</h3></h3>
						</h3>";
						$word = $row["word"];
						$sound = $row["sound"];

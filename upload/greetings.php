                        ...
                        <div class="card bg-dark" style="border-radius: 15px; color:  rgb(255, 223, 79); --bs-bg-opacity: 0.8;">
                            <div class="card-body p-5">
                                ...
                                <form class="form-signin" action="" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-outline mb-4">
                                        <input type="text" name="engWord" class="form-control form-control-lg" />
                                        <label class="form-label" for="engWord">English Word</label>
                                    </div>

                                    <div class="form-outline mb-4">
                                        <!-- <div id="controls">
                                            <button class="btn btn-warning" id="recordButton">Record</button>
                                            <button class="btn btn-warning" id="pauseButton" disabled>Pause</button>
                                            <button class="btn btn-warning" id="stopButton" disabled>Stop</button>
                                        </div> -->
                                        <input type="file" accept="audio/*" name="sound" class="form-control form-control-lg" />

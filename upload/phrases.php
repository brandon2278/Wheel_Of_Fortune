                            ...
                            <div class="card-body p-5">
                                ...
                                <form class="form-signin" action="" method="POST" enctype="multipart/form-data">
                                    <div class="form-outline mb-4">
                                        <input name="phrase" type="text" maxlength="255" class="useGameKeyboard form-control form-control-lg" />
                                        <label class="form-label" for="phrase">Mikmaw Phrase</label>
                                    </div>
                                    <div class="form-outline mb-4">
                                        <input type="file" accept="audio/*" name="phraseSound" class="form-control form-control-lg" />
                                        <label class="form-label" for="phraseSound">Choose Phrase Audio</label>
                                    </div>
                                    <div class="form-outline mb-4">
                                        <input name="response" type="text" maxlength="255" class="useGameKeyboard form-control form-control-lg" />
                                        <label class="form-label" for="response">Mikmaw Response</label>
                                    </div>
                                    <div class="form-outline mb-4">
                                        <input type="file" accept="audio/*" name="responseSound" class="form-control form-control-lg" />
                                        <label class="form-label" for="responseSound">Choose Response Audio</label>
                                    </div>
                                    <div class="form-outline mb-4">
                                        <input name="englishPhrase" type="text" class="form-control form-control-lg" />
                                        <label class="form-label" for="englishPhrase">English Phrase Translation</label>
                                    </div>
                                    <div class="form-outline mb-4">
                                        <input name="englishResponse" type="text" class="form-control form-control-lg" />
